...
public class SinglyLinkedList<E> implements List<E>, Serializable {
    ...
    public E get(int position) {
        ...
        if(position==0) return head.getElement();
        if(position==size()-1) return tail.getElement();
    ...
    public int indexOf(E element) {
        ...
        if(tail.getElement().equals(element)) return currentSize-1;

        SinglyListNode<E> node = head;
        for(int i=1; i<size()-1;i++) {
            node = node.getNext();
            if(node.getElement().equals(element)) return i;
        }
        return -1;
    }
    ...
    public void addFirst(E element) {
        if(this.isEmpty()) {
            ...
            head = new SinglyListNode<>(element, head);
        }
        currentSize++;
    }
    ...
    public void add(int position, E element) {
        ...
        if(position==0) addFirst(element);
            ...
            SinglyListNode<E> oldNode = head;
            for(int i =0;i<position-1;i++) {
                oldNode = oldNode.getNext();
            }
            SinglyListNode<E> nextNode = oldNode.getNext();
    ...
    public E removeLast() {
        ...
        SinglyListNode<E> removed = node.getNext();
        tail = node;
        tail.setNext(null);
        currentSize--;
    ...
    public E remove(int position) {
        ...
        if(position==size()-1) return removeLast();
            ...
            SinglyListNode<E> oldNode = node.getNext();
